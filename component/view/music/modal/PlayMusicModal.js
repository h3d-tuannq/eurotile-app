...
class PlayMusicModal extends React.Component{
    ...
    constructor(props){
        ...
        console.log("class PlayMusicModal extends React.Component{")
    ...
    onShare = async () => {
        try {
            const result = await Share.share({
              message:`Mời nghe bài hát ${this.state.program_name_text} trên app VOV Media`,
            });
    ...
    componentDidMount() {
        console.log("PlayMusicModal componentDidMount");
    ...
    setInfo(model){
        ...
        this.setState({program_name_text:model["name"]});
    ...
    interactBtnClick(){
        this.props.navigation.navigate('commentMusic', {screen:'player',item:this.props.route.params.item});
    }
                ...
                <View style={{flex: 1, justifyContent : 'space-between'}}>
                    ...
                    <View style={styles.playerContainer}>
                        ...
                        <View style={styles.player}>
                            <MusicPlayer item={this.props.route.params.item} data={this.props.route.params.data}  share={this.onShare}  back={this.onPrev} next={this.onNext}/>
                        </View>
                        </View>
                    </View>
